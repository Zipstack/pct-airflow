...
func (a *SClient) CopyFromFile(ctx context.Context, file os.File, remotePath string, permissions string) error {
...
func (a *SClient) CopyFromFilePassThru(ctx context.Context, file os.File, remotePath string, permissions string, passThru PassThru) error {
	stat, err := file.Stat()
	if err != nil {
...
func (a *SClient) CopyFile(ctx context.Context, fileReader io.Reader, remotePath string, permissions string) error {
...
// if the file length in know in advance please use "Copy" instead.
// Access copied bytes by providing a PassThru reader factory.
func (a *SClient) CopyFilePassThru(ctx context.Context, fileReader io.Reader, remotePath string, permissions string, passThru PassThru) error {
...
func (a *SClient) Copy(ctx context.Context, r io.Reader, remotePath string, permissions string, size int64) error {
...
// Access copied bytes by providing a PassThru reader factory
func (a *SClient) CopyPassThru(ctx context.Context, r io.Reader, remotePath string, permissions string, size int64, passThru PassThru) error {
...
func (a *SClient) CopyFromRemote(ctx context.Context, file *os.File, remotePath string) error {
...
func (a *SClient) CopyFromRemotePassThru(ctx context.Context, w io.Writer, remotePath string, passThru PassThru) error {
	session, err := a.sshClient.NewSession()
	if err != nil {
